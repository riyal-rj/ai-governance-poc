...
from src.bootstrap.lifecycle import make_lifespan, ContainerFactory
from src.core.config import AppSettings, load_settings
from src.observability.http_middlware import RequestTelemetryMiddleware
from src.core.logging import configure_logging

def create_app(settings: AppSettings | None = None,
               container_factory: ContainerFactory | None = None) -> FastAPI:
