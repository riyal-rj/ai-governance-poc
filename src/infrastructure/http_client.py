...
def create_http_client(settings: HttpClientSettings,
                       *,
                       service_name: str,
                       service_version: str) -> httpx.AsyncClient:
    """Create onre bounded pooled client to reuse accross dependency adapters."""
